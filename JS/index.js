...
var media = [
  {
    ...
    image: "Sample/Tracy/Fashion_Yellow_Beach.jpg",
    tags: ["fashion"],
    likes: 62,
    date: "2011-12-08",
    price: 55,
...

  {
    ...
    image: "Sample/Tracy/Fashion_Urban_Jungle.jpg",
    tags: ["fashion"],
    likes: 11,
    date: "2011-11-06",
    price: 55,
  },
  {
    ...
    image: "Sample/Tracy/Fashion_Pattern_on_Pattern.jpg",
    tags: ["fashion"],
    likes: 72,
    date: "2013-08-12",
    price: 55,
  },
  {
    ...
    image: "Sample/Tracy/Event_WeddingGazebo.jpg",
    tags: ["events"],
    likes: 69,
    date: "2018-02-22",
    price: 55,
  },
  {
    ...
    photographerId: 82,
    title: "Sparkles",
    image: "Sample/Tracy/Event_Sparklers.jpg",
    tags: ["events"],
    likes: 2,
    date: "2020-05-25",
    price: 55,
  },
  {
    ...
    image: "Sample/Tracy/Event_18thAnniversary.jpg",
    tags: ["events"],
    likes: 33,
    date: "2019-06-12",
    price: 55,
  },
  {
    ...
    video: "Sample/Tracy/Art_Wooden_Horse_Sculpture.mp4",
    tags: ["art"],
    likes: 24,
    date: "2011-12-08",
    price: 100,
  },
  {
    ...
    photographerId: 82,
    title: "Triangle Man",
    image: "Sample/Tracy/Art_Triangle_Man.jpg",
    tags: ["art"],
    likes: 88,
    date: "2007-05-07",
    price: 55,
  },
  {
    ...
    photographerId: 82,
    title: "Purple Tunnel",
    image: "Sample/Tracy/Art_Purple_light.jpg",
    tags: ["art"],
    likes: 24,
    date: "2018-05-05",
    price: 55,
  },
  {
    ...
    photographerId: 82,
    title: "Art Mine",
    image: "Sample/Tracy/Art_Mine.jpg",
    tags: ["art"],
    likes: 75,
    date: "2019-11-25",
    price: 55,
...
photographersData.forEach((element) => {
  const elementIndex = new Photographe(element).getElementIndex();
...
const divPhotographe = document.querySelectorAll(".photographer");

for (let x = 0; x < tagsNavigation.length; x++) {
  tagsNavigation[x].addEventListener("click", () => {
    for (let a = 0; a < tagsNavigation.length; a++) {
      tagsNavigation[a].classList.remove("red");
    }
    tagsNavigation[x].setAttribute("data-active", "active");
    tagsNavigation[x].classList.add("red");

    divPhotographe.forEach((item) => {
      for (let i = 0; i < item.querySelectorAll("li").length; i++) {
        item.querySelectorAll("li")[i].classList.remove("red");
      }
      for (let j = 0; j < item.querySelectorAll("li").length; j++) {
        const alltags = item.querySelectorAll("li")[j];
        if (alltags.dataset.value != tagsNavigation[x].dataset.value) {
          item.classList.add("display");
        } else if (alltags.dataset.value == tagsNavigation[x].dataset.value) {
          item.classList.add("display");
          item.classList.remove("display");
          alltags.classList.add("red");
          return;
        }
      }
    });
